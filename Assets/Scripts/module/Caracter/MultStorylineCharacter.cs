using UnityEngine;
/// <summary>
/// 本角色会多故事线谈话在剧情结束后会赠送收藏品或气球给 Jimmy
/// </summary>
public class MultStorylineCharacter : CharacterBehaviour
{
    private bool hasGifted = false; // 是否已经赠送过礼物
    private bool hasBalloon = false; // 是否已经赠送过气球
    ...
    {
        if (!hasBalloon && flowchart.GetBooleanVariable("gifted"))
        {
            hasBalloon = true;
